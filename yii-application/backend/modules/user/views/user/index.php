        ...
        <?php
            echo ListView::widget([
                ...
                'itemView' => function ($model, $key, $index, $widget) {
                    ...
                    $select = "<select class='form-control col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12'>";
                                ...
                                "<div class='my_box_content rounded-bottom bg-light border border-top-0 border-dark'>".
                                    "<div class='row py-2'>".
                                        ...
                                        "<div id='user_data-".$model->id."' class='px-4 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12' >".
                                            "<h5 class='mt-0'>".$model->employeename." - ".$model->position->name_position."</h5>".
                                        ...
                                        "<div id='user_data_edit-".$model->id."' class='px-4 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12' style='display: none;'>".
                                            "<h5><p class='form-row my-2 mx-2'> <input class='form-control col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12' type='text' value='".$model->employeename."' placeholder='".$model->employeename."'> - ".
                                            $select.
                                            "</p>".
                                            "</h5>".
                                            "<p class='form-row my-2'><img class='my_icon mx-1 my-2' src='".Url::to(['/img/mail.svg'])."'> <input class='form-control col-10' type='mail' value='".$model->email."' placeholder='".$model->email."'> </p>".
                                            "<p class='form-row my-2'><img class='my_icon mx-1 my-2' src='".Url::to(['/img/smartphone-call.svg'])."'> <input class='form-control col-10' type='text' value='".$model->phone."' placeholder=".$model->phone."> </p>".
                                            "<p class='form-row my-2'><img class='my_icon mx-1 my-2' src='".Url::to(['/img/home.svg'])."'> <input class='form-control col-10' type='text' value='".$model->address."' placeholder='".$model->address."'> </p>".
                                        "</div>".
                                    "</div>".    
                                "</div>".
                            "</div>".
