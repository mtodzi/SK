                            ...
                            <div class="">
                                ...
                                <div id='orders_clients_form-0'>
                                    ...
                                    <p id='p_orders_clients_phone-0-1' class="form-row my-2 orders_phone-0 orders_phone">
                                        ...
                                        <input id='input_orders_clients_phone-0-1' name='ClientsPhonesEdit[phone_number-1]'  form='' class="form-control col-8 phone phone_input" type="text" placeholder="*Введите номер телефона">
                    ...
                    foreach ($ClientsPhones as $phone){
                        $phonestr = $phonestr."".
                            "<p id='p_orders_clients_phone-".$model->id_orders."-".$i."' class='form-row my-2 orders_phone-".$model->id_orders." orders_phone'>".
                                "<img class='my_icon mx-1 my-2' src='".Url::to(['/img/smartphone-call.svg'])."'>".
                                "<input id='input_orders_clients_phone-".$model->id_orders."-".$i."' name='ClientsPhonesEdit[phone_number-".$i."]' value='".$phone->phone_number."'  form='' class='form-control col-8 phone phone_input' type='text' placeholder='*Введите номер телефона'>";
                                if($count>1){
                                $phonestr = $phonestr."".
