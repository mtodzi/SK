    ...
    foreach ($OrdersClamedMalfunction as $malfunction){
        ...
        "<div id = 'div_orders_malfunction-".$model->id_orders."-".$i."'class='div_orders_malfunction-".$model->id_orders."'>        
            <p id='p_orders_malfunction-".$model->id_orders."-".$i."' class='form-row my-2 orders_malfunction-".$model->id_orders." orders_malfunction'>
                <input id='input_orders_malfunction-".$model->id_orders."-".$i."' name='MalfunctionEdit[malfunction][".$i."]' data-input = '".$malfunction->claimedMalfunction->claimed_malfunction_name."' data-input-name = 'malfunction' value='".$malfunction->claimedMalfunction->claimed_malfunction_name."'  form='form_orders-".$model->id_orders."' class='input_orders form-control col-8 malfunction_input malfunction_input-".$model->id_orders."' type='text' placeholder='Заявленная неисправность'>";       
                if($count>1){
                    $phonestr = $phonestr."".
                    "<a  id = 'delete_another_malfunction-".$model->id_orders."-".$i."' class='btn btn-dark delete_another_malfunction mx-1'   data-toggle='tooltip' data-placement='right' title='Удалить заявленную неисправность'>".
            ...
            </p>".Html :: hiddenInput('MalfunctionEdit[claimed_malfunction_id]['.$i.']', $malfunction->claimed_malfunction_id, ['id'=>('orders_claimed_malfunction_id-'.$model->id_orders.'-'.$i),'class'=>'hidden_malfunction_input hidden_malfunction_input-'.$model->id_orders,'form'=>'form_orders-'.$model->id_orders]).
        "</div>";                               
        $i++;
    }
    $phonestr = $phonestr."".
    "<p id ='p_add_another_malfunction-".$model->id_orders."' class='form-row my-2'>
    ...
    $phonestr = $phonestr."".
        "<div id = 'div_orders_malfunction-0-1'class='div_orders_malfunction-0'>        
            <p id='p_orders_malfunction-0-1' class='form-row my-2 orders_malfunction-0 orders_malfunction'>
                <input id='input_orders_malfunction-0-1' name='MalfunctionEdit[malfunction][1]' data-input = '' data-input-name = 'malfunction' value=''  form='form_orders-0' class='input_orders form-control col-8 malfunction_input malfunction_input-0' type='text' placeholder='Заявленная неисправность'>       
            ...
            </p>".Html :: hiddenInput('MalfunctionEdit[claimed_malfunction_id][1]', 0, ['id'=>'orders_claimed_malfunction_id-0-1','class'=>'hidden_malfunction_input hidden_malfunction_input-0','form'=>'form_orders-0']).
        "</div>                       
        <p id ='p_add_another_malfunction-0' class='form-row my-2'>
