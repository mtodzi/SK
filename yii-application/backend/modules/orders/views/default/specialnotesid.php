...
<p class='form-row my-2 mx-2'> 
    <textarea class='form-row input_orders_special_notes input_orders' style='resize: none;' rows="3" cols="70"
             ...
             name='OrdersEdit[special_notes]' data-input-name = "special_notes" form='form_orders-<?=(($model!=null)?$model->id_orders:0)?>'  
             autofocus maxlength="300" placeholder="Особые заметки"><?=(($model!=null)?$model->special_notes:'')?></textarea></p>
