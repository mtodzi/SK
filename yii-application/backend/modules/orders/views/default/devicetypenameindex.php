...
<p class="form-row my-2"> 
    <input id='input_orders_device_type-<?=(($modelOrders!=null)?$modelOrders->id_orders:0)?>' 
        name='OrdersEdit[device_type_name]'  form='' 
...
<p id = 'error_orders_device_type-<?=(($modelOrders!=null)?$modelOrders->id_orders:0)?>' class='text-danger my-2 mx-2' style='display: none;'>Ошибка</p>