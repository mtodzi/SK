...
<p class="form-row my-2"> 
    <input id='input_orders_device_type_name-<?=(($modelOrders!=null)?$modelOrders->id_orders:0)?>' 
        name='DeviceTypeEdit[device_type_name]' data-input-name = "device_type_name"  form='form_orders-<?=(($modelOrders!=null)?$modelOrders->id_orders:0)?>' 
    ...
    <?=Html :: hiddenInput('DeviceTypeEdit[id_device_type]', (($modelDeviceTypeName!=null)?$modelDeviceTypeName->id_device_type:0), ['id'=>$id, 'form'=>'form_orders-'.(($modelOrders!=null)?$modelOrders->id_orders:0)])?>
</p>
