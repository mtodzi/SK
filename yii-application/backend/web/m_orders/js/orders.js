...
//Обработчик нажатия закрыть заказ в userbox 
$('.my_content_bloc').on('click', '.orders_close_button', function () {
    var id = GetId($(this), 1);
    data = {
        'id': id,
    ...
    $.ajax({
        url: '/yii-application/backend/web/orders/default/closeorder',
        type: 'POST',
        data: data,
