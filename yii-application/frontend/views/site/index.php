    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-9">
            <p align="justify">Система разработана для использования в небольших сервисных мастерских и предназначена для упрощения 
               ...
               Система реализована при помощи объектно-ориентированного компонентного фреймворка Yii2 и предусматривает возможности расширения до полноценной CMS.
               При реализации системы использованы технологии адаптивной верстки, Bootstrap4, HTML5, CSS3, AJAX, PHP-7, JScript, JQerry...
            </p>
            <br>
            <p>
        ...
        <div class='col-xs-12 col-sm-4 col-md-3'>
            ...
            <li class='letter_red'>Клиенты</li>
            ...
            <li class='letter_red'>Витрина</li>
